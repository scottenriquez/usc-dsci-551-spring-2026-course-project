...
function buildArchitecture(): { nodes: Node[]; edges: BuiltInEdge[] } {
  ...
  // Service positions: centered above each subnet
  ...
  const nodes: Node[] = [
    ...
    // API Gateway - centered above left subnet
    {
      id: 'apigw',
    ...
    // CDN - centered above right subnet
    {
      id: 'cloudfront',
    ...
    // Lambda - centered inside private subnet
    {
      id: 'lambda',
    ...
    // YugabyteDB - same size as private subnet, aligned beside it
    {
      id: 'yugabyte',
